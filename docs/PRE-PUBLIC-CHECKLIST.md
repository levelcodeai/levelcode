...
git clone /Users/sdemian/sdemian/systemu-net/atom-plus-plus /tmp/app-clean
cd /tmp/app-clean
...
Result: `CLAUDE.md`, `PLAN.md`, `extensions/`, `LICENSE`, `README.md` at the root; all commits preserved
